(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_createDocument_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************/
...
/*
    ...
    $table->timestamp('date_supplier')->nullable();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      supplier_search: "",
      isLoad: false,
      param_document_id: this.$route.params.document_id,
      ...
      /*
          document_type {
      1:Документ поставщика
      2:Документ поступления
      }
      */
      optionsDocument: [{
        value: 1,
        text: 'Документ поставщика'
      }, {
        value: 2,
  ...
  methods: {
    resetFormCreate: function resetFormCreate() {
      this.formCreateData.supplier_id = null;
      this.formCreateData.supplier_name = 0;
      this.formCreateData.name = "";
      this.formCreateData.store_id = 0;
      this.formCreateData.description = "";
      this.formCreateData.document_type = null;
      this.formCreateData.date_supplier = "";
    },
    sendData: function sendData() {
      if (this.isViewCreate) {
        console.log("sendCreateDocument");
        this.sendCreateDocument();
      } else {
        console.log("sendUpdateDocument");
        this.sendEditDocument();
      }
    },
    sendCreateDocument: function sendCreateDocument() {
      var _this = this;
      ...
      axios.post('/api/create_document', this.formCreateData).then(function (response) {
        _this.resetFormCreate();

        _this.$router.push('/documents-list');
      })["catch"](function (errors) {
        _this.create_errors = errors.response.data.errors;
      });
    },
    sendEditDocument: function sendEditDocument() {
      var _this2 = this;

      var token = localStorage.getItem('token');
      axios.defaults.headers.common['Authorization'] = 'Bearer ' + token;
      this.formCreateData.document_id = this.param_document_id;
      axios.post('/api/update_document', this.formCreateData).then(function (response) {
        _this2.resetFormCreate();

        _this2.$router.push('/documents-list');
      })["catch"](function (errors) {
        _this2.create_errors = errors.response.data.errors;
      });
    },
    getDetailDocument: function getDetailDocument() {
      var _this3 = this;
      ...
      */
      ...
      axios.post('/api/detail_document_info', {
        "document_id": this.param_document_id,
        "store_id": this.cur_store_id
      }).then(function (response) {
        _this3.formCreateData.name = response.data.document.name;
        _this3.formCreateData.number = response.data.document.number;
        _this3.formCreateData.description = response.data.document.description;
        _this3.formCreateData.date_supplier = response.data.document.date_supplier;
        _this3.formCreateData.document_type = response.data.document.document_type;
        _this3.formCreateData.supplier_id = response.data.document.supplier_id;
        _this3.formCreateData.supplier_name = response.data.document.supplier_name;
      })["catch"](function (errors) {
        _this3.create_errors = errors.response.data.errors;
      });
    },
    makeSupplierPagination: function makeSupplierPagination(response) {
      var pagination = {
    ...
    showSelectSupplier: function showSelectSupplier() {
      this.getSuppliers();
      $(this.$refs.modal2).modal('show');
    },
    selectSupplier: function selectSupplier(supplier_id, supplier_name) {
      this.formCreateData.supplier_id = supplier_id;
      this.formCreateData.supplier_name = supplier_name;
      $(this.$refs.modal2).modal('hide');
    },
    getSuppliers: function getSuppliers(page_url) {
      var _this4 = this;

      var token = localStorage.getItem('token');
      axios.defaults.headers.common['Authorization'] = 'Bearer ' + token;
      page_url = page_url || '/api/get_contractor_list'; //console.log(page_url)

      var contractor_type = 1; //поставщик

      var data = {
        "store_id": this.cur_store_id,
        "supplier_search": this.supplier_search,
        "contractor_type": contractor_type
      }; //axios.post(page_url, {"store_id": this.cur_store_id }).then((response) => {

      axios.post(page_url, data).then(function (response) {
        //console.log('suppliers length:'+response.data.contractors.data.length)
        _this4.suppliers = response.data.contractors.data;

        _this4.makeSupplierPagination(response.data.contractors);
      })["catch"](function (errors) {
        console.log(errors);
      });
    },
    startTimer: function startTimer() {
      ...
      this.timer = setInterval(function () {
        if (_this5.lastCollection === "suppliers") {
          _this5.getSuppliers();
        }
...
/***/ "./resources/js/Pages/createDocument.vue":
/*!***********************************************!*\
  !*** ./resources/js/Pages/createDocument.vue ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createDocument.vue?vue&type=template&id=682b2080& */ "./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080&");
/* harmony import */ var _createDocument_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createDocument.vue?vue&type=script&lang=js& */ "./resources/js/Pages/createDocument.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _createDocument_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__.render,
  _createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Pages/createDocument.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/Pages/createDocument.vue?vue&type=script&lang=js&":
/*!************************************************************************!*\
  !*** ./resources/js/Pages/createDocument.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_createDocument_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./createDocument.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_createDocument_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 

/***/ }),

/***/ "./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080&":
/*!******************************************************************************!*\
  !*** ./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080& ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_createDocument_vue_vue_type_template_id_682b2080___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./createDocument.vue?vue&type=template&id=682b2080& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/createDocument.vue?vue&type=template&id=682b2080& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
        ...
        _c("div", { staticClass: "modal-dialog modal-lg" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c(
              ...
              [
                _c("label", { attrs: { for: "supplier_search" } }, [
                  _vm._v("Поставщики")
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.supplier_search,
                      expression: "supplier_search"
                    }
                  ],
                  ...
                  domProps: { value: _vm.supplier_search },
                  on: {
                    input: [
                      function($event) {
                        ...
                        _vm.supplier_search = $event.target.value
                      },
                      function($event) {
                        return _vm.changeValueInput($event, "suppliers")
                      }
                    ]
                  }
                }),
                ...
                _vm._l(_vm.suppliers, function(supplier) {
                  return _c("div", { key: supplier.id, staticClass: "row" }, [
                        ...
                        _c("ul", { staticClass: "pagination" }, [
                          _c(
                            "li",
                            {
                              ...
                              class: {
                                disabled: !_vm.supplierPagination.prev_page_url
                              },
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.getSuppliers(
                                    _vm.supplierPagination.prev_page_url
                                  )
                                }
                              }
                            },
                            ...
                            _c(
                              ...
                              [
                                _vm._v(
                                  "\n                                        Страница " +
                                    _vm._s(
                                      _vm.supplierPagination.current_page
                                    ) +
                                    " из " +
                                    _vm._s(_vm.supplierPagination.last_page) +
                                    "\n                                    "
                                )
                              ]
                            )
                          ...
                          _c(
                            "li",
                            {
                              staticClass: "page-item",
                              class: {
                                disabled: !_vm.supplierPagination.next_page_url
                              },
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.getSuppliers(
                                    _vm.supplierPagination.next_page_url
                                  )
                                }
                              }
                            },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { attrs: { for: "number" } }, [_vm._v("Номер документа")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("b-form-select", {
          attrs: { name: "document_type", options: _vm.optionsDocument },
          model: {
            value: _vm.formCreateData.document_type,
            callback: function($$v) {
              _vm.$set(_vm.formCreateData, "document_type", $$v)
            },
            expression: "formCreateData.document_type"
          }
        }),
        _vm._v(" "),
        _c("p", {
          staticClass: "text-danger",
          domProps: { textContent: _vm._s(_vm.create_errors.document_type) }
        })
      ],
      1
    ),
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { attrs: { for: "date_supplier" } }, [
        _vm._v("Дата поставки")
      ]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.formCreateData.date_supplier,
            expression: "formCreateData.date_supplier"
          }
        ],
        staticClass: "form-control",
        attrs: { type: "text", name: "date_supplier" },
        domProps: { value: _vm.formCreateData.date_supplier },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.formCreateData, "date_supplier", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      _c("p", {
        staticClass: "text-danger",
        domProps: { textContent: _vm._s(_vm.create_errors.date_supplier) }
      })
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.formCreateData.supplier_name,
            expression: "formCreateData.supplier_name"
          }
        ],
        staticClass: "form-control",
        attrs: {
          ...
          "aria-label": "Выбор поставщика",
          "aria-describedby": "button-addon2",
          readonly: ""
        },
        domProps: { value: _vm.formCreateData.supplier_name },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.formCreateData, "supplier_name", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
